...
function card(id: number, deckId: number, front: string, updated: Date, created = T0): CardRow {
  return {
    ...
    nextReviewAt: T0, consecutiveCorrect: 0, lastCorrectAt: null, timesMissed: 0, editedAt: null, lastAnsweredAt: null, lastMissedAt: null,
...
function memo(id: number, title: string, updated: Date, created = T0): Memo {
  return {
    ...
    pinned: false, parentId: null, position: id, createdAt: created, updatedAt: updated,
  };
}
